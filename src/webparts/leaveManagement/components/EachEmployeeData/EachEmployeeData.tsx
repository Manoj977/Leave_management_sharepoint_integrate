...
const EachEmployeeData = ({
  ...
  if (data.EachEmployeeDetails.length !== 0) {
    CurrentData = data.EachEmployeeDetails
      .slice(indexFirstData, indexOfLastPage)
      .sort((a: any, b: any) => {
  ...
  return (
    <div className={styles.totalLeave} style={{ flexDirection: 'column' }}>
      <div className={styles.totalLeaveDiv1} style={{ width: '80%', borderRadius: '1rem' }}>
        <div
        ...
        >
            ...
            {!isLoading && (
              <div className={styles.totalLeaveHeaderDiv}>
                <p>
                  ...
                  <span>{data.EachEmployeeDetails.length > 0 && data.EachEmployeeDetails[0].ID}</span>
                </p>
              </div>
            )}
          </header>
          <button
            ...
            style={{ color: 'rgb(153, 171, 180)', borderRadius: '50%', border: 'none' }}
        ...
        <div
          style={{ marginTop: '4rem', overflow: 'scroll', maxHeight: '13rem', padding: '0px' }}
        ...
        >
          ...
          >
            {isLoading ? (
              ...
              <table className={styles.approvalTable} style={{ minWidth: '100%', margin: 'auto 3rem' }}>
                ...
                <tbody>
                  {CurrentData.map((leaveDetail: any) => (
                    <tr key={leaveDetail.ID}>
                      <td style={{ textAlign: 'center' }} className={styles.approvalTableDescription}>
